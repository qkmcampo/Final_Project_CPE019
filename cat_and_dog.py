...
# -- Page Configuration --
st.set_page_config(page_title="🐾 Cat and Dog Classifier", page_icon="🐶", layout="centered")
...
if uploaded_file is not None:
    ...
    img_array = image.img_to_array(img_resized) / 355.0
